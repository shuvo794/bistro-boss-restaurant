...
function Menu() {
  ...
  return (
    <div>
      ...
      <MenuCatagory items={pizza} title="pizza" img={menuCover2}></MenuCatagory>

      {/* salad section */}

      <MenuCatagory items={salad} title="salad" img={menuCover3}></MenuCatagory>

      {/* SOUPS section */}

      <MenuCatagory items={soup} title="soup" img={menuCover4}></MenuCatagory>
    </div>
  );
}
